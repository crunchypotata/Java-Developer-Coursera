...
private int currentIndex = 2; //TODO 2 To track which train is currently displayed
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        stage.show();
        /* TODO 8: Use JavaFX’s Timeline or Ani@@mationTimer to create a repeating task. This task will update the Label with the next train’s details every 5 seconds. */
